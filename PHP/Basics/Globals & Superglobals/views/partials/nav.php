<nav class="bg-gray-800">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/about.php" class="rounded-md <?= $_SERVER['REQUEST_URI'] === '/about.php' ? 'bg-gray-900 text-white' : 'text-gray-300' ?> px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">About Us</a>
              <a href="/contact.php" class="rounded-md <?= $_SERVER['REQUEST_URI'] === '/contact.php' ? 'bg-gray-900 text-white' : 'text-gray-300' ?> px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Contact Us</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
        <a href="/" class="block rounded-md <?= ($_SERVER['REQUEST_URI'] === '/' || $_SERVER['REQUEST_URI'] === '/index.php') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> px-3 py-2 text-base font-medium hover:bg-white/5 hover:text-white">Home</a>
        <a href="/about.php" class="block rounded-md <?= $_SERVER['REQUEST_URI'] === '/about.php' ? 'bg-gray-900 text-white' : 'text-gray-300' ?> px-3 py-2 text-base font-medium hover:bg-white/5 hover:text-white">About Us</a>
        <a href="/contact.php" class="block rounded-md <?= $_SERVER['REQUEST_URI'] === '/contact.php' ? 'bg-gray-900 text-white' : 'text-gray-300' ?> px-3 py-2 text-base font-medium hover:bg-white/5 hover:text-white">Contact Us</a>
      </div>
